...
Let me paint you a picture of what ryanyogan.com used to be. It was simple. Beautifully, boringly simple. A static site, built with Next.js, no Remix, no... (I honestly don't remember anymore, I changed monthly), hosted on Vercely, then Fly.io for faster responses, with maybe a dozen pages that I updated once a year when I felt guilty about neglecting my online presence.

And you know what? That was fine. It worked. Nobody complained.

But here's the thing about having two decades of experience and a tendency to overcomplicate personal projects: "fine" isn't good enough when you can build something absurd.
...
│   │   ├── content/
│   │   │   ├── projects.md     # THE magic file
│   │   │   └── writing/        # Blog posts (auto-generated!)
│   │   ├── src/
...
│   ├── ai-worker/              # Scheduled jobs
│   └── shared/                 # Shared types
├── .github/
│   └── workflows/
│       └── generate-posts.yml  # The trigger
...
This is where it gets thorough. The workflow doesn't just grab a README. It fetches _every single file_ from the repository:
...
3. **It scales with my ADHD/Tinkering-Mindset.** The system doesn't care that I've moved on to the next thing. It quietly generates content for whatever I marked as featured.
...
- An avid tinkerer that forgets to write posts
- Someone with too many GitHub repos who needs automation
- Comfortable with Cloudflare's ecosystem (Workers, D1, R2, Vectorize, Workflows)
- Willing to pay for Claude API calls

If you love writing and waxing poetic before jumping into coding, this is probably a waste of your Cloudflare resources. Just use Astro or even plain HTML. They work great.
