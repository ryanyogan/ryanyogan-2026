...
export const fallbackExperiences = [
  {
    ...
    current: false,
    description:
      "Pre-IPO construction tech. Led platform initiatives and engineering teams. Built real-time systems serving millions of construction professionals worldwide.",
    highlights: [
  ...
  },
  {
    ...
    current: false,
    description:
      "High-frequency trading firm. Built low-latency trading systems and real-time market data infrastructure. Performance-critical software where milliseconds matter.",
    highlights: [
  ...
  },
  {
    ...
    current: false,
    description:
      "Multiple startup experiences. Built products from zero to scale. Grew engineering teams from 0 to 40+ people. Full-stack development across web and mobile.",
    highlights: [
